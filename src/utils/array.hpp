 ...
 *        types, templates and functions.
 *
 * \{
 *
 * \file utils/array.hpp
 * \brief This file contains convenient functions
 *        to be used in conjunction with
 *        std::array.
 */

#ifndef H_utils_array
#define H_utils_array

#include <iterator>

namespace UtopiaOS
{
    /** \namespace UtopiaOS::utils
     * \brief Everything in the module Utilities
    ...
    namespace utils
    {
        ...
        namespace detail
        {
            ...
            struct make_array
            {
                ...
                -> typename std::enable_if<!use_cast, std::array<T, N + sizeof...(Args)>>::type
                {
        ...
        struct make_array
        {
            ...
            {
                using value_type = typename std::conditional<std::is_void<T>::value,
                typename std::iterator_traits<ForwardIterator>::value_type,
                T
                >::type;
